...
MODEL = 'cnn'  # default: 'hog', other one can be 'cnn' - CUDA accelerated (if available)
known_faces = []
known_names = []
known_faces_dir =''
...
def main():
  ...
  ap.add_argument("-d","--dir", type=str, default="./what_faces/",
      action='store',
      help="path to directory of known faces")
  ...
  print("Starting up with", args['dir'])
